...
<header class="header">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12">
              <div class="header-location"><i class="fa fa-home"></i> <a href="#">迈考海滩的普吉西北海岸</a></div>
              <div class="header-email"><i class="fa fa-envelope-o"></i> <a href="mailto:support@email.com">54846116@qq.com</a></div>
  ...
  <script type="text/javascript">
   ...
   <script src="http://code.jquery.com/jquery-1.10.2.min.js"></script>
    <div id="b" style="display:none;width:100px;height:100px;background:#ccc;">收尾</div>
