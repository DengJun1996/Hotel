            ...
            <div class="row">
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                    ...
                    <div class="footer-top_txt">
                        <p>Delux · Sea Side Hotel 是一间五星级精品商务综合型酒店。地处迈考海滩的普吉西北海岸地带，购物、娱乐方便快捷。酒店位于各交通网络之交汇点，是商旅人士云集之处。</p>
                    </div>
                    <div class="footer-top_address">
                        <div><i class="fa fa-phone"></i> 电话： <span>0769 - 8888888</span></div>
                        <div><i class="fa fa-envelope-o"></i> E-mail: <span><a href="mailto:support@email.com">54846116@qq.com</a></span></div>
                        <div><i class="fa fa-home"></i> 地址: <span>迈考海滩的普吉西北海岸</span></div>
                    </div>
                </div>
                <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
