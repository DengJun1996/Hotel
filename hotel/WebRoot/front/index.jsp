...
<head>
  ...
  <title>Delux · Sea Side Hotel</title>
...
<body>
  ...
  <div class="wrapper">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="parallax-text">
                <h1 class="parallax_t __white">Delux · Sea Side Hotel</h1>
                <h2 class="parallax_t __green">迈考海滩的普吉西北海岸----<a href="#" id="show">预定</a></h2>
                <p>Delux · Sea Side Hotel拥有精致客房、一流的会议空间、商务友好设施和非凡的服务，可为宾客提供完美的休闲住宿体验。 客房配有豪华床上用品、高速上网接入、全尺寸桌子和符合人体工学原理的座椅。 您可享受 Asia Bistro 餐厅和 Alto Vino 意式餐厅，也可到 Pulp 酒吧品一杯葡萄酒，还可到 YI Ho 中餐厅体验传统粤菜。</p>
              </div>
                
            </div>
     
            <!-- planner -->
            <div id="a" class="col-lg-6 col-md-6 col-sm-12 col-xs-12 planner"  >
              <div class="planner-block" id="booking" >
    ...
    <section class="best-room">
      ...
      <h2 class="h2">Delux · Sea Side Hotel<span class="title-secondary">特色客房</span></h2>   
        </div>
  ...
  <script id="commentshow" type="text/html">
    <div class="item">
      ...
      <div class="testimonials-block_user">
        <div class="user_img"><img src="${basePath}/static/front/images/testimonials/girl.jpeg" alt=""></div>
...
<!-- 主体body下部  加载房间 -->
  ...
  <script type="text/javascript">
      ...
      layui.use('laytpl', function(){
          ...
          console.log("拿到的romtype:"+roomtype);
          $.ajax({
              type: "post",//请求方式
